 ...
 * 
 * Rather than being attached to a single object, an EventBus provides a central pathway to send events across the whole
 * application.
 * 
...
public interface EventBus {
  ...
  // Remove these as implementation details for now
