...
@OtherTypes(intf = IsPopupPanel.class, stub = StubPopupPanel.class)
public class PopupPanel extends com.google.gwt.user.client.ui.PopupPanel implements IsPopupPanel {
